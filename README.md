...
Here you can take visualize your data set for one animal at a time or the whole data set. If supplied the app with ID's in the "Create Track" tab and only choose ***one*** active ID ***or no*** ID at all, you can see an interactive map here.
