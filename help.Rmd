...
nocite: | 
  @LaPoint2013, @lavgar2016integrated, @signer2019animal, @avgar2017relative, @thurfjell2014applications, @lele2013selection, @duchesne2015equivalence
---
...
However, Avgar [-@avgar2017relative] suggests an interpretation of the coefficients as Relative Selection Strength (RSS) is correct. Generally speaking the relative risk is the ratio of a probability that an event will occur in a treatment group to the probability of the same event occurring in a control group. In context of habitat selection it is referred to as the RSS [@avgar2017relative]. For example a RSS of 5 between locations 1 and 2 means an animal is five times more likely to choose location 1 over 2.
