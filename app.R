...
fisher <- read.csv("amtGUI/data/fisher_1016.csv")
fisher_day <- read.csv("amtGUI/data/fisher_1016_day.csv")
fisher_night <- read.csv("amtGUI/data/fisher_1016_night.csv")
deer_ny <- read.csv("amtGUI/data/Martes pennanti LaPoint New York.csv", 
                    #stringsAsFactors = FALSE, 
                    check.names = TRUE)

land_use <- raster::raster("amtGUI/data/landuse_study_area.tif")
